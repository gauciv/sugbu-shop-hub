  ...
  if (error || !order) {
    return (
      <div className="mx-auto max-w-lg px-4 py-16 sm:px-6 text-center">
        ...
        <h1 className="mt-5 font-display text-2xl font-bold tracking-tight">Order Not Found</h1>
        <p className="mt-2 text-muted-foreground">
          We couldn&apos;t load this order. It may have been removed or the link is invalid.
        </p>
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link to="/shops">
            <Button className="w-full shadow-cozy sm:w-auto">
