  ...
  return (
    <div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
          <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="text-center lg:text-left animate-fade-in-up">
              ...
              <span className="mb-4 inline-flex items-center gap-2 rounded-full border border-pink-200 bg-pink-50 px-4 py-1.5 text-sm font-semibold text-pink-500">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4">
            {[
              ...
              <div key={item.title} className={`rounded-[20px] border-2 ${item.border} bg-white p-4 sm:rounded-[24px] sm:p-5`}>
      ...
      {!loading && shops.length > 0 && (
        <section className="bg-secondary/70 py-8 sm:py-10">
          <div className="mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
            <div className="mb-5 flex items-end justify-between sm:mb-6">
              <div className="flex items-center gap-2 sm:gap-3">
      ...
      {!session && (
        <section className="py-8 sm:py-12">
          <div className="mx-auto max-w-3xl px-4 sm:px-8">
            <div className="relative overflow-hidden rounded-2xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 via-pink-50 to-purple-50 px-6 py-8 text-center sm:rounded-[28px] sm:px-14 sm:py-10">
              {/* Doodle decorations */}
